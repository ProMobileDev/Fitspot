    ...
    render(){
                ...
                case 1:
                    return(
                        <div className="text-center">
                            <h2 style={{margin: '15px 0', display: 'block'}}>Select photo</h2>
                            ...
                            <button className="btn btn-info btn-lg btn-block" onClick={::this.close}>
                                Close
                            </button>
                            {
                                this.state.fileError ? <div className="alert alert-danger">
                                        {
        ...
        return(
            <div>
                {step ? '' :
                    <div className="text-center">
                        <img className="user-avatar img-circle" src={user.avatar.url} alt={user.firstname} />
                    </div>}
                ...
                {step ? '' : <button type="submit" onClick={::this.changeProfileImage} className="btn btn-info btn-lg btn-block marginBottom50">Change Profile Picture</button>}
            </div>
        )
    }
