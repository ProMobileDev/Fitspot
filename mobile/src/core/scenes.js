/* @flow *
 <Scene key="subscribe" tabIcon={TabIcon} icon={TabIcon} component={connect(state=>({userType:state.auth.user.userType}))(Switch)} tabs={true} selector={props=>props.userType == 2 ? "main" : "subscribe2"}  >
...
import {EditBookingScene, BookingTrainerConfirmationScene,BookingTrainInformationScene,BookingTrainerWorkoutScene,BookingTrainWorkoutDetailsScene, BookingWorkoutDetailsScene, BookingPastWorkoutScene, ChooseActivityScene, ChooseLocationScene, LocationDetailScene, ChooseTrainerScene, ChooseDateTimeScene, BookingConfirmationScene,BookingSubscriptionOptionsScene} from '@Booking/scenes'
import {SplashScene} from '@Splash/scenes'
import {TrainerSupportScene} from '@TrainerSupport/scenes'
    ...
    <Scene key="modal" component={Modal} >
      <Scene  key="myTabBar" tabs tabBarStyle={{alignItems: 'center',justifyContent: 'center', alignSelf:'center',backgroundColor: '#ffffff'}}>
          ...
          <Scene intial={true}  key="home" tabIcon={TabIcon} icon={TabIcon} leftButtonIconStyle={{ tintColor: DEFAULT_GREEN_COLOR}}>
            ...
            <Scene key="workoutDetails" title= 'Workout Details' component={BookingTrainWorkoutDetailsScene} titleStyle={{fontFamily: FONT_DAYTONA_BOLD,
              fontSize: 14,color : "#000"}} navigationBarStyle={{backgroundColor: 'white',borderBottomColor: 'transparent', borderBottomWidth: 65}} hideNavBar={false} hideTabBar/> 
            ...
            <Scene key="upComingWorkout" title= 'Upcoming Workout' component={BookingTrainerWorkoutScene} titleStyle={{fontFamily: FONT_DAYTONA_BOLD,
              fontSize: 14,color : "#000"}} navigationBarStyle={{backgroundColor: 'white',borderBottomColor: 'transparent', borderBottomWidth: 65}} hideNavBar={false} hideTabBar/> 

            <Scene key="trainingInformation" title= 'Training Information' component={BookingTrainInformationScene} titleStyle={{fontFamily: FONT_DAYTONA_BOLD,
              fontSize: 14,color : "#000"}} navigationBarStyle={{backgroundColor: 'white',borderBottomColor: 'transparent', borderBottomWidth: 65}} hideNavBar={false} hideTabBar/>   

          </Scene>

          <Scene key="trainer_support" tabIcon={TabIcon} icon={TabIcon} leftButtonIconStyle={{ tintColor: DEFAULT_GREEN_COLOR}}>
            <Scene key="trainerSupport" title='Trainer Support' component={TrainerSupportScene} titleStyle={{fontFamily: FONT_DAYTONA_BOLD,
                  fontSize: 17,color : "#000"}}  navigationBarStyle={{backgroundColor: 'rgba(0,0,0,0)'}}/>
