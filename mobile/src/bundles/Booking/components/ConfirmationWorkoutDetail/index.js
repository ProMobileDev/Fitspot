      ...
      <View style ={styles.clientContainer}>
        ...
        <View style={{backgroundColor:'white', borderBottomColor:'black'}}>
          ...
          <View style={{flexDirection: 'row',alignItems: 'center',justifyContent: 'center', marginTop: 20}}>
            <View style={{flexDirection: 'column', alignItems:'center', justifyContent: 'center', marginTop:5, marginLeft:15}}>
            ...
            <View style={{flexDirection: 'column', alignItems:'center', justifyContent: 'center', marginTop:5,marginLeft:25}}>
