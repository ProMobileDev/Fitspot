...
class HomeViewWorkoutInfo extends React.Component{
  ...
  goToDetails(){
    enableWorkout = 'undefined';
    Actions.confirmPastWorkout();
  }
  renderInvalidWorkout(){
    return (
      <View style ={styles.row}>
        ...
        <View style={[styles.rowBottom, {borderBottomColor:'#E7E7E7', borderBottomWidth:2}]}>
        ...
        <View style={{backgroundColor:'white'}}>
          <Text style={{marginTop:10,marginBottom:6,fontFamily:FONT_DAYTONA_REG,fontWeight:'400',fontSize:12,textAlign:'left',marginLeft:15}}>12 CO-WORKERS ATTENDING</Text>
        ...
        <View style={{flex: 1,flexDirection: 'row'}}>
          <TouchableHighlight onPress={this.goToDetails} underlayColor='rgba(0,0,0,0)' style={[styles.rowBottomColumn, {flex:1,marginRight: 0, height: 50, borderBottomLeftRadius:6,borderBottomRightRadius:6, backgroundColor:'#C9C9C9'}]}>
            <View style={{alignSelf:'center',flexDirection:'row',}}>
              <Image source={require('@images/check-in-black-icon.png')} style={{width: 20, height: 20}} />
              <Text style={{fontWeight:'700', fontSize:15,fontFamily:FONT_DAYTONA_BOLD,color:'#4B4B4C'}}> Going</Text>
            </View>
          </TouchableHighlight>
  ...
  render(){
    if(typeof enableWorkout == "undefined"){
      return this.renderInvalidWorkout()
    }else{
      return this.renderInvalidWorkout()
    }
